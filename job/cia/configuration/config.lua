...
Config.customJail = true -- Set to true if you want to add jail option to menu(Requires you to edit rom_cia:sendToJail event in client/cl_customize.lua)
...
Config.searchPlayers = true -- Allow cia jobs to search players (Must set correct inventory above)
...
Config.tackle = {
    ...
    ciaOnly = true, -- cia jobs only use tackle?
...
Config.Locations = {
    CIA = {
        blip = {
            enabled = true,
            coords = vec3(-373.1826, -236.1611, 35.8545),
            sprite = 60,
            color = 28,
            scale = 0.8,
            string = 'CIA '
        ...
        bossMenu = {
            ...
            jobLock = 'cia', -- Lock to specific cia job? Set to false if not desired
            coords = vec3(-311.6145, -272.7031, 39.8927), -- Location of boss menu (If not using target)
            label = '[E] - Menu Patron', -- Text UI label string (If not using target)
            ...
            target = {
                ...
                label = 'Accéder au menu Parton ',
                coords = vec3(-311.6145, -272.7031, 39.8927),
                heading = 269.85,
                width = 2.0,
                length = 1.0,
                minZ = 30.73-0.9,
        ...
        armoury = {
            ...
            coords = vec3(-332.7890, -251.2672, 33.3955), -- Coords of armoury
            heading = 241.3039, -- Heading of armoury NPC
            ped = 's_f_y_cop_01',
            label = '[E] - Acces Armes', -- String of text ui
            jobLock = 'cia', -- Allow only one of Config.ciaJob listings / Set to false if allow all Config.ciaJobs
            weapons = {
...
--                    ['armour'] = { label = 'Bulletproof Vest', multiple = false, price = 100 }, -- Example
        ...
        cloakroom = {
            ...
            jobLock = 'cia', -- Allow only one of Config.ciaJob listings / Set to false if allow all Config.ciaJobs
            coords = vec3(-340.2850, -253.3359, 32.7068), -- Coords of cloakroom
            label = '[E] - Prendre ta tenue', -- String of text ui of cloakroom
        ...
        vehicles = { -- Vehicle Garage
            ...
            jobLock = 'cia', -- Job lock? or access to all cia jobs by using false
            zone = {
                coords = vec3(-368.4514, -248.5881, 32.9372), -- Area to prompt vehicle garage
            ...
            spawn = {
                land = {
                    coords = vec3(-360.5082, -245.4687, 32.5252), -- Coords of where land vehicle spawn/return
                    heading = 264.5890
                },
                air = {
            ...
            options = {
                ...
                [0] = { -- Job grade as table name
                    ...
                    ['fbi2'] = { -- Car/Helicopter/Vehicle Spawn Code/Model Name
                        label = 'cia Cruiser #2',
                        category = 'land', -- Options are 'land' and 'air'
                    },
